...
public class Domainr3HaneliHarfveNumaraOrtadaCOM extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr3HaneliHarfveNumaraOrtadaCOM.csv");
        ...
        for (int i = 0; i < alphabet.size(); i++) {
            ...
            for (int c = 0; c < alphabet.size(); c++) {
                ...
                for (int x = 0; x < Number.size(); x++) {
                    ...
                    String domain = alphabet.get(i) + Number.get(x) + alphabet.get(c);
