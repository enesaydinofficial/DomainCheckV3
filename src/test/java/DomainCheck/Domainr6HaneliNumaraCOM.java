...
public class Domainr6HaneliNumaraCOM extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr6HaneliNumaraCOM.csv");
                    ...
                    for (int n = 0; n < Number.size(); n++) {
                        ...
                        for (int u = 0; u < Number.size(); u++) {
                            ...
                            for (int x = 0; x < Number.size(); x++) {
                                ...
                                String domain = Number.get(i) + Number.get(c) + Number.get(b) + Number.get(n) + Number.get(u) + Number.get(x);
