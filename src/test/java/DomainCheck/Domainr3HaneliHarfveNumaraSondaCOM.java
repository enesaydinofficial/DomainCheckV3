...
public class Domainr3HaneliHarfveNumaraSondaCOM extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr3HaneliHarfveNumaraSondaCOM.csv");
        ...
        for (int i = 0; i < alphabet.size(); i++) {
            ...
            for (int c = 0; c < alphabet.size(); c++) {
                ...
                for (int x = 0; x < Number.size(); x++) {
                    ...
                    String domain = alphabet.get(i) + alphabet.get(c) + Number.get(x);
