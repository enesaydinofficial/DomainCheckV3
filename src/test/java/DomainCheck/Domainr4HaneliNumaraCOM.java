...
public class Domainr4HaneliNumaraCOM extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr4HaneliNumaraCOM.csv");
            ...
            for (int c = 0; c < Number.size(); c++) {
                ...
                for (int b = 0; b < Number.size(); b++) {
                    ...
                    for (int x = 0; x < Number.size(); x++) {
                        ...
                        String domain = Number.get(i) + Number.get(c) + Number.get(b) + Number.get(x);
