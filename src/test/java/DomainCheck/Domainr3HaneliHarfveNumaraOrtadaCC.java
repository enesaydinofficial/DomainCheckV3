...
public class Domainr3HaneliHarfveNumaraOrtadaCC extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr3HaneliHarfveNumaraOrtadaCC.csv");
