...
public class Domainr4HaneliHarfveNumaraSondaCOM extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr4HaneliHarfveNumaraSondaCOM.csv");
            ...
            for (int c = 0; c < alphabet.size(); c++) {
                ...
                for (int b = 0; b < alphabet.size(); b++) {
                    ...
                    for (int x = 0; x < Number.size(); x++) {
                        ...
                        String domain = alphabet.get(i) + alphabet.get(c) + alphabet.get(b) + Number.get(x);
