...
public class Domainr3HaneliNumaraNET extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr3HaneliNumaraNET.csv");
        ...
        for (int i = 0; i < Number.size(); i++) {
            ...
            for (int c = 0; c < Number.size(); c++) {
                ...
                for (int x = 0; x < Number.size(); x++) {
                    ...
                    String domain = Number.get(i) + Number.get(c) + Number.get(x);
