...
public class Domain2HaneliNumaraCC extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domain2HaneliNumaraCC.csv");
