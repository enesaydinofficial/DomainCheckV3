...
public class Domainr4HaneliHarfveNumaraUÇNET extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr4HaneliHarfveNumaraUÇNET.csv");
