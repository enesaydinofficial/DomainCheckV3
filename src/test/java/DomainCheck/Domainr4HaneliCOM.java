...
public class Domainr4HaneliCOM extends BaseClass {
    ...
    public void CheckDomainThreeDigit() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr4HaneliCOM.csv");
            ...
            for (int x = 0; x < alphabet.size(); x++) {
                ...
                for (int z = 0; z < alphabet.size(); z++) {
                    ...
                    for (int c = 0; c < alphabet.size(); c++) {
                        ...
                        String domain = alphabet.get(i) + alphabet.get(x) + alphabet.get(z) + alphabet.get(c);
