...
public class Domain2HaneliNumaraCOM extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domain2HaneliNumaraCOM.csv");

        for (int i = 0; i < Number.size(); i++) {

            for (int x = 0; x < Number.size(); x++) {

                String domain = Number.get(i) + Number.get(x);
