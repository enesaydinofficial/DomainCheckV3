...
public class Domainr2HaneliHarfveNumaraSonCOM extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr2HaneliHarfveNumaraSonCOM.csv");

        for (int i = 0; i < alphabet.size(); i++) {

            for (int x = 0; x < Number.size(); x++) {

                String domain = alphabet.get(i) + Number.get(x);
