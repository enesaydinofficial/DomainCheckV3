...
public class Domainr3HaneliHarfveNumaraOrtadaNET extends BaseClass {
    ...
    public void CheckDomainTwoDigitCC() throws Exception {
        ...
        FileWriter writer = new FileWriter(System.getProperty("user.dir") + "\\src\\main\\resources\\Domainr3HaneliHarfveNumaraOrtadaNET.csv");
